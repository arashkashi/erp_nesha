...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post order_items_url, params: { order_item: { amount: @order_item.amount, order_id: @order_item.order_id, pipe_type_id: @order_item.pipe_type_id } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { amount: @order_item.amount, order_id: @order_item.order_id, pipe_type_id: @order_item.pipe_type_id } }
